...
<body>
                    ...
                    <tbody>
                        @foreach($issues as $issue)
                            <tr>
                                ...
                                <td>{{ $issue->status }}</td>
                                <td>
								<a href="{{ route('issues.edit', $issue->id) }}" class="btn btn-primary text-white">Sửa</a>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js" integrity="sha384-pzjw8f+ua7Kw1TIq0X8q0M77O4CkR14d6zqI0tkHxlFw3a0cH3gOaXc7iTqegODf" crossorigin="anonymous"></script>
</body>
</html>
